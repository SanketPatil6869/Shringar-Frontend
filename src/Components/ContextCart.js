...
const ContextCart = () => {
  ...
  let payNow = async (e) => {
    ...
    if (totalAmount == "" || totalAmount < 0) {
      Swal.fire("Enter Valid Amount", "Total amount is not valid", "question");
    } else {
      let body = {
        id: cid,
        amount: totalAmount,
      ...
      if (res.data.status == "created") {
        let options = {
          key: "rzp_test_nqkdQ7xDegI8Rh",
          currency: "INR",
          amount: res.data.amount,
          name: "Welcome to Shringar",
  ...
  return (
    <>
      <header className="headerclass mt2">
