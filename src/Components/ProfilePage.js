...
export const ProfilePage = () => {
    ...
    let getUser = async () => {
        let url = "http://localhost:8080/user-profile-info/" + JSON.parse(sessionStorage.getItem("UserId"));
    ...
    let updateUserProfile = (e) => {
        ...
        if (feildStatus == "disabled") {
            ...
            try {
                axios
                    .put("http://localhost:8080/update-user-info", body)
                    .then((res) => {
                        console.log(res.data);
                        if (res.data) {
    ...
    let updateUserAddress = (e) => {
        ...
        if (feildStatusAdd == "disabled") {
            ...
            try {
                axios
                    .put("http://localhost:8080/update-user-address", body)
                    .then((res) => {
                        console.log(res.data);
                        if (res.data) {
                    ...
                    <div className="col-md-3 border-end">
                        <div className="row mt-3">
                            <div className="d-flex flex-column align-items-center text-center">
                                <form>
                                    {/* <div className="image w-50" user={userInfo.userImg}></div> */}

                                    <div className="font-weight-bold mt-4">
                                        {userInfo.firstName + " " + userInfo.lastName}
                                    </div>
                                    <div className="text-black-50">{userInfo.email}</div>
                        ...
                        <form onSubmit={updateUserAddress} >
                            ...
                            <div className="row">
                                <div className="col-md-6 mb-4 d-flex align-items-center">
                                    <div className="form-outline datepicker w-100">
                                        <label htmlFor="PIN" className="form-label text-dark fs-6">
                                            PIN
                                        </label>
                                        <input
                                            type="text"
                                ...
                                <div className="col-md-6 mb-4 d-flex align-items-center">
                                    <div className="form-outline datepicker w-100">
                                        <label htmlFor="City" className="form-label text-dark fs-6">
                                            City
                                        </label>
                                        <input
                                            type="text"
                            ...
                            <div className="row">
                                <div className="col-md-12 mb-4 d-flex align-items-center">
                                    <div className="form-outline datepicker w-100">
                                        <label htmlFor="state" className="form-label text-dark fs-6">
                                            State
                                        </label>
                                        <input
                                            type="text"
